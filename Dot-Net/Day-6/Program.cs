...
namespace ConsoleApp1
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            var datasource = @"LAPTOP-UUNJE1T0"; // your server
        ...
        static void InsertStaff(SqlConnection conn) 
        {
            ...
            int std_id = 2;
            string name = "shubham";
            string contact = "8320633601";
            string querry = "insert into student (std_id,std_name,std_contactno) values(@std_id,@name,@contact)";
